...
//    [leftButton setFrame: CGRectMake(0.0, 0.0, 40.0, 40.0)];
//    [leftButton setTitle: @"←" forState: UIControlStateNormal];
//    [leftButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
//    [leftButton setBackgroundColor: [UIColor whiteColor]];
//    [leftButton addTarget: self action: @selector(textViewButtonPressed) forControlEvents: UIControlEventTouchUpInside];
//
//    UIButton *rightButton = [UIButton buttonWithType: UIButtonTypeCustom];
//    [rightButton setFrame: CGRectMake(42.0, 0.0, 40.0, 40.0)];
//    [rightButton setTitle: @"→" forState: UIControlStateNormal];
//    [rightButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
//    [rightButton setBackgroundColor: [UIColor whiteColor]];
//    [rightButton addTarget: self action: @selector(textViewButtonPressed) forControlEvents: UIControlEventTouchUpInside];
//
